...
$ docker inspect docker-rsyslog_receiver_1 | grep IPAddress
            "SecondaryIPAddresses": null,
            "IPAddress": "",
...
```
$ ssh -lroot -p10003 localhost 'hostname; logger -n 172.22.0.1 -P 10002 hogehoge; echo sent!!'
root@localhost's password:
rsyslog_sender
sent!!
$ ssh -lroot -p10001 localhost 'hostname;tail -1 /var/log/syslog'
root@localhost's password:
rsyslog_receiver
